...
page 50008 pyronixApi
{
    ...
    Caption = 'pyronixApi';
    DelayedInsert = true;
    EntityName = 'pyronixApi';
    EntitySetName = 'pyronixApi';
    PageType = API;
    SourceTable = Item;
    SourceTableView = where(Type = const(Inventory),Blocked = const(false),"Vendor No." = const('100467411'));
