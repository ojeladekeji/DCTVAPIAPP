...
page 50007 texecomApi
{
    ...
    Caption = 'texecomApi';
    DelayedInsert = true;
    EntityName = 'texecomApi';
    EntitySetName = 'texecomApi';
    PageType = API;
    SourceTable = Item;
    SourceTableView = where(Type = const(Inventory),Blocked = const(false),"Vendor No." = const('V0000060'));
