...
page 50006 ruijieApi
{
    ...
    Caption = 'ruijieApi';
    DelayedInsert = true;
    EntityName = 'ruijieApi';
    EntitySetName = 'ruijieApi';
    PageType = API;
    SourceTable = Item;
    SourceTableView = where(Type = const(Inventory),Blocked = const(false),"Vendor No." = const('107705706'));
