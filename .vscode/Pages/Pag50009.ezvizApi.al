...
page 50009 ezvizApi
{
    ...
    DelayedInsert = true;
    EntityName = 'ezvizApi';
    EntitySetName = 'ezvizApi';
    PageType = API;
    SourceTable = Item;
    SourceTableView = where(Type = const(Inventory),Blocked = const(false),"Vendor No." = const('85175191'));
    ...
    begin
        ...
        itemLedgerEntry.SetRange("Location Code", 'MAIN');
        itemLedgerEntry.CalcSums(Quantity);
        pacetechInventory := itemLedgerEntry.Quantity;
